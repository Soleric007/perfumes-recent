        ...
        <div class="row align-items-center cs_gap_y_40">
          ...
          <div class="col-lg-5 offset-xl-1">
            ...
            <form method="POST" action="{{ route('login') }}">
              ...
              <input type="email" name="email" :value="old('email')" required autofocus autocomplete="username" class="cs_form_field">
            <x-input-error :messages="$errors->get('email')" class="mt-2" />
              ...
              <div class="cs_password">
                ...
                required autocomplete="current-password" class="cs_password_input cs_form_field">
            ...
            <p class="mb-0 cs_light cs_primary_color">Don't have an account? <a href="{{route('register')}}" class="cs_accent_color cs_semibold">Signup Now</a></p>
          </div>
        </div>
      </div>
    </div>
