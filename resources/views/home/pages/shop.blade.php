...
<html class="no-js" lang="en">
  ...
  <body>
    ...
    <div class="container">
      <div class="cs_breadcamp_wrap cs_style_1 cs_type_1 cs_accent_light_bg cs_bg_filed cs_radius_8" data-src="assets/images/breadcamp_bg_2.jpeg">
        <div>
    ...
    <div class="container">
            ...
            <div class="cs_view_box_in">
              <button type="button" class="cs_list_view">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M22.5 21H1.50001C0.671548 21 0 20.3284 0 19.5C0 18.6716 0.671548 18 1.50001 18H22.5C23.3285 18 24.0001 18.6716 24.0001 19.5C24 20.3284 23.3285 21 22.5 21Z" fill="currentColor"/>
                  <path d="M22.5 13.5H1.50001C0.671548 13.5 0 12.8284 0 12C0 11.1716 0.671548 10.5 1.50001 10.5H22.5C23.3285 10.5 24.0001 11.1715 24.0001 12C24.0001 12.8285 23.3285 13.5 22.5 13.5Z" fill="currentColor"/>
                  <path d="M22.5 5.99996H1.50001C0.671548 5.99996 0 5.32841 0 4.49995C0 3.67149 0.671548 2.99994 1.50001 2.99994H22.5C23.3285 2.99994 24.0001 3.67149 24.0001 4.49995C24.0001 5.32841 23.3285 5.99996 22.5 5.99996Z" fill="currentColor"/>
                  </g>
                  <defs>
      ...
      <div class="cs_grid_5_column cs_products_view cs_style_1">
          ...
          <div class="cs_product_card cs_style_1 cs_radius_12">
            <div class="cs_product_card_in">
              ...
              <div class="cs_product_info">
                ...
                <h2 class="cs_product_title cs_fs_18 cs_normal cs_secondary_font">Rosewater Hydrating Mist</h2>
        ...
        <div class="cs_grid_col">
          <div class="cs_product_card cs_style_1 cs_radius_12">
            <div class="cs_product_card_in">
              ...
              <div class="cs_product_info">
                <div class="cs_product_category text-uppercase cs_fs_14 cs_light">
                  <a href="{{route('shop.show')}}">PURE GLOW</a>
                </div>
                <h2 class="cs_product_title cs_fs_18 cs_normal cs_secondary_font">Charcoal Detoxifying Mask</h2>
                <p class="cs_product_price cs_fs_24 cs_primary_color cs_medium">$14.99 <small>$18.99</small></p>
                <div class="cs_product_ratings">
        ...
        <div class="cs_grid_col">
          <div class="cs_product_card cs_style_1 cs_radius_12">
            <div class="cs_product_card_in">
              <div class="cs_product_thumb cs_center">
                <img src="/template/assets/images/product_4.png" alt="Product">
                <div class="cs_products_btns">
                  <button class="cs_btn cs_style_1 cs_medium cs_size_md">
                    <img src="/template/assets/images/icons/cart_white.svg" alt="">
                    <span>Add To Bag</span>
              ...
              <div class="cs_product_info">
                <div class="cs_product_category text-uppercase cs_fs_14 cs_light">
                  <a href="{{route('shop.show')}}">RADIANT SKINCARE</a>
                </div>
                <h2 class="cs_product_title cs_fs_18 cs_normal cs_secondary_font">Vitamin C Serum</h2>
        ...
        <div class="cs_grid_col">
          <div class="cs_product_card cs_style_1 cs_radius_12">
            <div class="cs_product_card_in">
              <div class="cs_product_thumb cs_center">
                <img src="/template/assets/images/product_5.png" alt="Product">
                <div class="cs_products_btns">
                  <button class="cs_btn cs_style_1 cs_medium cs_size_md">
                    <img src="/template/assets/images/icons/cart_white.svg" alt="">
                    <span>Add To Bag</span>
              ...
              <div class="cs_product_info">
                <div class="cs_product_category text-uppercase cs_fs_14 cs_light">
                  <a href="{{route('shop.show')}}">HAIR LUX</a>
                </div>
                <h2 class="cs_product_title cs_fs_18 cs_normal cs_secondary_font">Argan Oil Hair Serum</h2>
                <p class="cs_product_price cs_fs_24 cs_primary_color cs_medium">$12.99 <small>$13.99</small></p>
                <div class="cs_product_ratings">
                  <div class="cs_rating" data-rating="4.5">
                    <div class="cs_rating_percentage"></div>
                  </div>
        ...
        <div class="cs_grid_col">
          <div class="cs_product_card cs_style_1 cs_radius_12">
            <div class="cs_product_card_in">
              ...
              <div class="cs_product_info">
                <div class="cs_product_category text-uppercase cs_fs_14 cs_light">
                  <a href="{{route('shop.show')}}">LUMINA BEAUTY</a>
                </div>
        ...
        <div class="cs_grid_col">
          <div class="cs_product_card cs_style_1 cs_radius_12">
            <div class="cs_product_card_in">
              ...
              <div class="cs_product_info">
                <div class="cs_product_category text-uppercase cs_fs_14 cs_light">
                  <a href="{{route('shop.show')}}">ARTISTRY</a>
                </div>
                <h2 class="cs_product_title cs_fs_18 cs_normal cs_secondary_font">Pro-Blend Makeup </h2>
                <p class="cs_product_price cs_fs_24 cs_primary_color cs_medium">$29.99</p>
                <div class="cs_product_ratings">
        ...
        <div class="cs_grid_col">
          <div class="cs_product_card cs_style_1 cs_radius_12">
            <div class="cs_product_card_in">
              ...
              <div class="cs_product_info">
                <div class="cs_product_category text-uppercase cs_fs_14 cs_light">
                  <a href="{{route('shop.show')}}">PUREGLOW NATURALS</a>
                </div>
        ...
        <div class="cs_grid_col">
          <div class="cs_product_card cs_style_1 cs_radius_12">
            <div class="cs_product_card_in">
              ...
              <div class="cs_product_info">
                <div class="cs_product_category text-uppercase cs_fs_14 cs_light">
                  <a href="{{route('shop.show')}}">SILK & SHINE</a>
                </div>
        ...
        <div class="cs_grid_col">
          <div class="cs_product_card cs_style_1 cs_radius_12">
            <div class="cs_product_card_in">
              ...
              <div class="cs_product_info">
                <div class="cs_product_category text-uppercase cs_fs_14 cs_light">
                  <a href="{{route('shop.show')}}">CHROMA COSMETICS</a>
                </div>
                <h2 class="cs_product_title cs_fs_18 cs_normal cs_secondary_font">Bold Matte Lipstick</h2>
                <p class="cs_product_price cs_fs_24 cs_primary_color cs_medium">$14.99 <small>$15.25</small></p>
                <div class="cs_product_ratings">
                  <div class="cs_rating" data-rating="4.5">
                    <div class="cs_rating_percentage"></div>
                  </div>
        ...
        <div class="cs_grid_col">
          <div class="cs_product_card cs_style_1 cs_radius_12">
            <div class="cs_product_card_in">
              <div class="cs_product_thumb cs_center">
                <img src="/template/assets/images/product_11.png" alt="Product">
                <div class="cs_products_btns">
                  <button class="cs_btn cs_style_1 cs_medium cs_size_md">
                    <img src="/template/assets/images/icons/cart_white.svg" alt="">
                    <span>Add To Bag</span>
              ...
              <div class="cs_product_info">
                <div class="cs_product_category text-uppercase cs_fs_14 cs_light">
                  <a href="{{route('shop.show')}}">GLOWGENIX</a>
                </div>
                <h2 class="cs_product_title cs_fs_18 cs_normal cs_secondary_font">Petroluemeum Jelly</h2>
                <p class="cs_product_price cs_fs_24 cs_primary_color cs_medium">$39.99 <small>$45.50</small></p>
                <div class="cs_product_ratings">
                  <div class="cs_rating" data-rating="4.5">
                    <div class="cs_rating_percentage"></div>
                  </div>
        ...
        <div class="cs_grid_col">
          <div class="cs_product_card cs_style_1 cs_radius_12">
            <div class="cs_product_card_in">
              <div class="cs_product_thumb cs_center">
                <img src="/template/assets/images/product_14.png" alt="Product">
                <div class="cs_products_btns">
                  <button class="cs_btn cs_style_1 cs_medium cs_size_md">
                    <img src="/template/assets/images/icons/cart_white.svg" alt="">
                    <span>Add To Bag</span>
        ...
        <div class="cs_grid_col">
          <div class="cs_product_card cs_style_1 cs_radius_12">
            <div class="cs_product_card_in">
              <div class="cs_product_thumb cs_center">
                <img src="/template/assets/images/product_15.png" alt="Product">
                <div class="cs_products_btns">
                  <button class="cs_btn cs_style_1 cs_medium cs_size_md">
                    <img src="/template/assets/images/icons/cart_white.svg" alt="">
                    <span>Add To Bag</span>
        ...
        <div class="cs_grid_col">
          <div class="cs_product_card cs_style_1 cs_radius_12">
            <div class="cs_product_card_in">
              <div class="cs_product_thumb cs_center">
                <img src="/template/assets/images/product_16.png" alt="Product">
                <div class="cs_products_btns">
                  <button class="cs_btn cs_style_1 cs_medium cs_size_md">
                    <img src="/template/assets/images/icons/cart_white.svg" alt="">
                    <span>Add To Bag</span>
        ...
        <div class="cs_grid_col">
          <div class="cs_product_card cs_style_1 cs_radius_12">
            <div class="cs_product_card_in">
              <div class="cs_product_thumb cs_center">
                <img src="/template/assets/images/product_20.png" alt="Product">
                <div class="cs_products_btns">
                  <button class="cs_btn cs_style_1 cs_medium cs_size_md">
                    <img src="/template/assets/images/icons/cart_white.svg" alt="">
                    <span>Add To Bag</span>
              ...
              <div class="cs_product_info">
                ...
                <h2 class="cs_product_title cs_fs_18 cs_normal cs_secondary_font">Radiant Serum</h2>
                <p class="cs_product_price cs_fs_24 cs_primary_color cs_medium">$39.99</p>
                <div class="cs_product_ratings">
                  <div class="cs_rating" data-rating="4.5">
                    <div class="cs_rating_percentage"></div>
        ...
        <div class="cs_grid_col">
          <div class="cs_product_card cs_style_1 cs_radius_12">
            <div class="cs_product_card_in">
              <div class="cs_product_thumb cs_center">
                <img src="/template/assets/images/product_22.png" alt="Product">
                <div class="cs_products_btns">
                  <button class="cs_btn cs_style_1 cs_medium cs_size_md">
                    <img src="/template/assets/images/icons/cart_white.svg" alt="">
                    <span>Add To Bag</span>
              ...
              <div class="cs_product_info">
                ...
                <h2 class="cs_product_title cs_fs_18 cs_normal cs_secondary_font">Color Pop Lipstick</h2>
                <p class="cs_product_price cs_fs_24 cs_primary_color cs_medium">$19.99</p>
                <div class="cs_product_ratings">
                  <div class="cs_rating" data-rating="5">
                    <div class="cs_rating_percentage"></div>
        ...
        <div class="cs_grid_col">
          <div class="cs_product_card cs_style_1 cs_radius_12">
            <div class="cs_product_card_in">
              <div class="cs_product_thumb cs_center">
                <img src="/template/assets/images/product_28.png" alt="Product">
                <div class="cs_products_btns">
                  <button class="cs_btn cs_style_1 cs_medium cs_size_md">
                    <img src="/template/assets/images/icons/cart_white.svg" alt="">
                    <span>Add To Bag</span>
              ...
              <div class="cs_product_info">
                ...
                <h2 class="cs_product_title cs_fs_18 cs_normal cs_secondary_font">Green Tea Body Lotion</h2>
                <p class="cs_product_price cs_fs_24 cs_primary_color cs_medium">$19.99</p>
                <div class="cs_product_ratings">
                  <div class="cs_rating" data-rating="4.5">
                    <div class="cs_rating_percentage"></div>
        ...
        <div class="cs_grid_col">
          <div class="cs_product_card cs_style_1 cs_radius_12">
            <div class="cs_product_card_in">
              <div class="cs_product_thumb cs_center">
                <img src="/template/assets/images/product_29.png" alt="Product">
                <div class="cs_products_btns">
                  <button class="cs_btn cs_style_1 cs_medium cs_size_md">
                    <img src="/template/assets/images/icons/cart_white.svg" alt="">
                    <span>Add To Bag</span>
              ...
              <div class="cs_product_info">
                ...
                <h2 class="cs_product_title cs_fs_18 cs_normal cs_secondary_font">Enchanted Perfume</h2>
                <p class="cs_product_price cs_fs_24 cs_primary_color cs_medium">$39.99</p>
                <div class="cs_product_ratings">
                  <div class="cs_rating" data-rating="4.5">
                    <div class="cs_rating_percentage"></div>
      ...
      <ul class="cs_pagination_box">
        <li>
          <a href="#" class="cs_pagination_arrow cs_pagination_arrow_left cs_center cs_accent_color">
        ...
        <li>
          <a class="cs_pagination_item cs_center" href="#">8</a>
        </li>
        <li>
          <a href="#" class="cs_pagination_arrow cs_pagination_arrow_right cs_center cs_accent_color">
            <svg width="11" height="20" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8.32057e-07 0.964762L4.21688e-08 19.0353C4.79022e-09 19.8904 1.03644 20.326 1.65182 19.7129L10.7206 10.6777C11.0931 10.3066 11.0931 9.69347 10.7206 9.32222L1.65182 0.286955C1.03644 -0.32599 8.69435e-07 0.109639 8.32057e-07 0.964762Z" fill="currentColor"/>
            </svg>
          </a>
        </li>
      </ul>
